      ...
      <main className={`flex-1 transition-all duration-300 ${isSidebarOpen ? 'lg:pl-64' : 'pl-0'}`}>
        ...
        <header className="sticky top-0 z-40 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-zinc-800/50 px-4 md:px-8 py-5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <Link to="/services" className="p-2.5 md:px-5 md:py-2.5 rounded-xl border border-zinc-800 hover:bg-zinc-900 transition-all flex items-center gap-2 font-bold uppercase text-[10px] tracking-widest text-zinc-400">
              <ExternalLink size={14} />
              <span className="hidden xs:inline">View Site</span>
            </Link>
            <button onClick={resetForm} className="p-2.5 md:px-5 md:py-2.5 rounded-xl bg-[#ffcc4d] text-black hover:bg-yellow-500 transition-all flex items-center gap-2 font-bold uppercase text-[10px] tracking-widest">
              <Plus size={14} />
        ...
        <div className="p-4 md:p-8 lg:p-12 max-w-7xl mx-auto">
          ...
          <div className="mb-8 md:mb-12">
            ...
            <p className="text-zinc-500 text-sm md:text-base font-medium tracking-wide">Create and update the professional services offered by Eluxen.</p>
          </div>
            ...
            <div className="lg:col-span-5">
              <div className={`bg-[#111111] border border-zinc-800/50 rounded-[24px] md:rounded-[32px] p-6 md:p-8 shadow-2xl transition-all duration-500 ${isEditing ? 'ring-2 ring-[#ffcc4d]/30 shadow-[#ffcc4d]/5' : ''}`}>
                <div className="flex items-center justify-between mb-6 md:mb-8">
                  <h2 className="text-lg md:text-xl font-bold italic text-white flex items-center gap-3">
